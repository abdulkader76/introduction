...
# my_object1 & my_object2 are said to have the same values when the equality operator returns True

# my_object1 is my_object2
# my_object1 & my_object2 are said to be reference the same objects when is comparison returns True
