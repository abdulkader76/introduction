...
# dict2 is not assigned to dict1 and both are distinct objects. But dict(dict1) creates a shallow copy of the dict1. The nested elements are reference the same list & tuple objects. When the list is mutated, dict2's nested lists are also changed.
